...
import green_circle from "./resources/green_circle (1).png";
import red_circle from "./resources/red_circle.png";
import {Button} from "react-toolbox/lib/button";
import Input from 'react-toolbox/lib/input';
import {Table, TableRow, TableCell, TableHead} from "react-toolbox/lib/table";
                    ...
                    <div id="content">
                        ...
                        <div id="ajax">
                            <Table id="the-only-table">
                                {data.map((item, idx) => {
                                    if (idx === 0) {
                                        if (document.querySelector("#root").clientWidth > 642) {
                                            return(
                                                <TableHead key={idx}>
